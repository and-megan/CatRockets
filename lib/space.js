...
class Space {
  ...
  step() {
    ...
    if (this.ship.isCollided(this.goal)) {
      ...
      this.ship.adjustCourse(this.ship, this.goal);
    }
...
*/
  ...
  cleanLitterBox(level) {
    return new Goal({
      //can change density (for testing purposes - this should really be in CONSTANTS I think -m)
      density: 1000,
      radius: 20,
      hue: 0,
